...
import { Directive, ElementRef, Input, Query, QueryList, Renderer } from '@angular/core';
...
export let LinkActive = class LinkActive {
    constructor(links, element, router$, renderer) {
        this.links = links;
...
LinkActive = __decorate([
    ...
    __metadata('design:paramtypes', [QueryList, ElementRef, Router, Renderer])
], LinkActive);
